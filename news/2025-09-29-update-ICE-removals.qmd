...
When we posted ICE removals data June 2025, we cautioned that the datasets might be incomplete. 

After receiving additional explanation from ICE, we now believe that the that the late July removals file --- which we had not posted until now --- is complete.  We also confirmed that the late June file is incorrect, and we have removed it from the data page (you can still [find it for reference](https://ucla.box.com/shared/static/1qmsmla2qgu8efs6yzeviaiblhecux7i.xlsx)).
...
removals |>
  ...
  #     if (month_name %in% c("Oct", "Jan")) {
  #       paste(month_name, format(x, "%Y"), sep = ". ")
  #     } else {
  #       month_name
  #     }
  #   },
