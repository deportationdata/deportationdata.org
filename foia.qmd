...
|   	|   	|
|---	|---	|
| **Request**  	| Spreadsheet data on ICE initial apprehensions, risk classification assessments, detentions, and removals with anonymized identifiers for immigrants. [PDF](/foia/aclu-v-ice/1 FOIA request.pdf) |
| **Requestor** |  David Hausman 	|
| **Agency response**  	|  None	|
| **Litigation** | Federal district court lawsuit, dismissed; overturned on appeal to 2nd circuit; data provided
| **Date**  	  |  Oct. 2018 	|
