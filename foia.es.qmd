...
|  |                                                                                                                                                                                                                                                                                          | 
|  | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Solicitar** | Datos sobre expulsiones de ICE, expulsiones de Comunidades Seguras, detenciones, arrestos/aprehensiones, encuentros, alternativas a la detención y órdenes de supervisión con identificadores anónimos para inmigrantes y números de caso EOIR de tribunales de inmigración vinculados. [PDF](/foia/cilp-v-ice-2024/1%20FOIA%20request.pdf) | 
...
| **Solicitante** | [Proyecto Derechos de los Inmigrantes de la ACLU](https://www.aclu.org/issues/immigrants-rights); [David Hausman](/team)                                                                                                                                                                                                                                                                                       | 
| **Fecha** | Oct. 2018                                                                                                                                                                                                                                                                                | 
| **Respuesta de la agencia** | Ninguna                                                                                                                                                                                                                                                                                  | 
