...
htmltools::tags$style(htmltools::HTML("
  thead select { display: none !important; }
  thead input { display: block !important; }
"))
...
df <- df |> slice(1) |> mutate(across(everything(), ~NA))
...
DT::datatable(
  ...
  options = list(
    dom = "Btp",  # no 'f' → hides the global search box
    serverSide = TRUE,
    processing = TRUE,
    pageLength = 100,
    scrollX = TRUE,
