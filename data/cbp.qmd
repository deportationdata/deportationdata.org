...
The most recent release of data is from April 2025 for apprehensions, March 2025 for people deemed inadmissible at the border, and September 2024 for encounters. We are actively seeking more recent updates.
...
tibble::tribble(
  ...
  reactable::reactable(columns = c(col_defs_cbp, list(Type = colDef(minWidth = 60))), pagination = FALSE)
```
