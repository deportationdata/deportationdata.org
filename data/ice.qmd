...
column_names <- readxl::read_excel(here::here(
  "resources/data_column_names.xlsx"
)) |>
  unite(
    col = "column_names",
...
tibble::tribble(
  ...
  left_join(
    column_names |> select(id, column_names) |> mutate(id = as.numeric(id)),
    by = c("URL" = "id")
  ) |>
      ...
      htmltools::div(
        ...
        htmltools::div(
          ...
          lapply(items, function(item) {
            htmltools::span(
              item,
              style = "border: 1px solid #ccc; border-radius: 4px; padding: 0.4em 1em; background: transparent; font-weight: 500; font-size: 0.95em;"
            )
          })
        )
      )
