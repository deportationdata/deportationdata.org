  ...
  c(
    ...
    list(
      ...
      Explore = colDef(
        ...
        #   # Apply gold background only if value is not null/empty
        #   if (!is.null(value) && length(value) > 0 && !is.na(value[[1]][[1]])) {
        #     list(backgroundColor = "#D9E3E8")
        #   }
        # },
        # headerStyle = list(
...
<div><i class="bi bi-arrow-90deg-left"></i><br>Explore the arrests data in our interactive tool, filtering it, and downloading subsets of interest.</div>
</div>
...
tibble::tribble(
  ...
  ~Records,
  ~Raw,
  # Updated column structure to match col_defs_ice_cleaned format
  "Arrests",
  "Oct. 2011",
  "Sep. 2023",
  "Aug. 2025",
  ...
  reactable::reactable(
    columns = col_defs_ice_cleaned[
      !names(col_defs_ice_cleaned) %in% c("Processed", "Explore")
    ],
    sortable = FALSE,
    pagination = FALSE
  )
