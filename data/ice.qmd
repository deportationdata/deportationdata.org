...
We include the **raw**, original data from ICE and, for arrests, a **processed**, cleaned version in multiple formats. The processed data includes an indicator for likely duplicates based on the arrest timing. We also provide a tool to **explore** the data and download filtered subsets of interest (for example, by location or time).
