...
col_defs_ice <- list(
  Start = colDef(minWidth = 80),
  End = colDef(minWidth = 80),
  Identifiers = colDef(
    name = "IDs",
...
col_defs_ice_cleaned <-
  c(
    col_defs_ice[-length(col_defs_ice)],
    list(
      Raw = colDef(
        minWidth = 40,
        html = TRUE,
      ...
      Explore = colDef(
        ...
        cell = function(value) {
          ...
          glue::glue(
            "<a href='https://0198ec54-fb71-461d-e5b7-15ab6dec6129.share.connect.posit.cloud'><i class='bi bi-search'></i></a>"
          )
        }
      )
    )
...
We include the **raw**, original data from ICE as well as, for the arrests table, a **processed**, cleaned version in multiple formats (Excel, Stata, SPSS, and feather for R and Python). The processed version includes an indicator for whether the record appears to be a duplicate, based on the timing of the arrest. 

In addition, for the arrests table, we provide a tool to **explore** the data and download filtered subsets of interest. View the processed data, filter it (by for example location or time), and download the filtered data. 
...
tibble::tribble(
  ...
  list(
    list(
      "https://ucla.box.com/shared/static/xslezyadivfi27xar08ht1l35lbvuq8e.xlsx",
      "38MB",
      "xlsx"
    ),
    list(
      "https://ucla.box.com/shared/static/fuyyppc4e5n4kzv120h5ed5bh5tn3gq8.dta",
      "144MB",
      "dta"
    ),
    list(
      "https://ucla.box.com/shared/static/tei14gumwoid9jt6sslk5zaeh6tfsk7q.sav",
      "119MB",
      "sav"
    ),
    list(
      "https://ucla.box.com/shared/static/1zv9nrvz3hixbzv95uwm2rfda299zzpt.feather",
      "37MB",
      "feather"
    )
  ),
  ...
  reactable::reactable(
    columns = c(col_defs_ice_cleaned, list(Type = colDef(minWidth = 70))),
    columnGroups = list(
      colGroup(name = "Downloads", columns = c("Raw", "Processed"))
    ),
    sortable = FALSE,
    pagination = FALSE
  )
...
[Download all the original files from the latest release (ZIP, 610 MB)](https://ucla.box.com/shared/static/tn6u3l3b6vb0i87wqlv8z38boasgru2f.zip){.btn-action-primary .btn-action .btn .btn-outline-primary .btn-sm role="button"} 
...
tibble::tribble(
  ...
  "Aug. 2025",
  "1.8M",
  "<a href='https://ucla.box.com/shared/static/3i6xhnd5cig3qacy5phxvw9cmy7a71k1.zip'>zip</a> (99 MB)",
  "Detentions",
  "Oct. 2011",
  "Sep. 2023",
  "Aug. 2025",
  "8.5M",
  "<a href='https://ucla.box.com/shared/static/gjfcedj3ne4d6l6rt5sv0t6yfao18jzp.zip'>zip</a> (1.41 GB)",
  "Removals",
  "Oct. 2011",
  "Sep. 2023",
  "Aug. 2025",
  "2.8M",
  "<a href='https://ucla.box.com/shared/static/hanv0cqbvxole910mo63z9uy40cwwi9t.zip'>zip</a> (499 MB)",
  "Risk classification assessment decisions",
  "Oct. 2011",
  "Sep. 2023",
  "Aug. 2025",
  "3.5M",
  "<a href='https://ucla.box.com/shared/static/x6jxz982onabumgfx0dwnd39b27ggoqz.zip'>zip</a> (596 MB)"
) |>
  reactable::reactable(
    columns = c(col_defs_ice, list(Type = colDef(minWidth = 65))),
    sortable = FALSE,
    pagination = FALSE
  )
```
...
[Download all the original files from the 2012-2023 data (ZIP, 2.6 GB)](https://ucla.box.com/shared/static/csnihndb826omzizlps90szm60q39jxd.zip){.btn-action-primary .btn-action .btn .btn-outline-primary .btn-sm role="button"} 
