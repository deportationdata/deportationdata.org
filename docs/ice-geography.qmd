...
map_data <- st_read_feather("ice-aor/ice_aor_map_data.feather")
# map_data <- ms_simplify(map_data, keep = 0.05, keep_shapes = TRUE)

field_offices <- st_read_feather("ice-aor/ice_field_offices_geocoded.feather")
...
# svglite("ice-aor/aor_map.svg", width = 9, height = 7)
# print(p1)
# dev.off()
