...
|   	|   	|
|---	|---	|
| **Request** 	| Data on encounters and people determined inadmissible into the United States by Customs and Border Protection.  |
| **Agency** |  Customs and Border Protection	|
| **Requestor** |  [Elora Mukherjee](/about.html#team); Deportation Data Project	|
| **Counsel** | [Amber Qureshi](/about.html#team) |
| **Date**  	  |  March 15, 2025	|
...
<details>
<summary>Show documents</summary>
...
tibble::tribble(
  ...
  ~Filing,
  ~Date,
  "2025.03.15_FOIA Request_CBP Encounters Inadmissibles.pdf", "CBP FOIA Office", "FOIA request", "Original request", as.Date("2025-03-15")
) |>
  mutate(
    Filing = glue::glue(
...
|   	|   	|
|---	|---	|
| **Request** 	| Data on ICE removals, Secure Communities removals, detentions, arrest/apprehensions, encounters, alternatives to detention, and orders of supervision with anonymized identifiers for immigrants and linked immigration court EOIR case numbers. |
| **Agency**    | Immigration and Customs Enforcement |
| **Requestor** |  [UCLA Center for Immigration Law and Policy](https://law.ucla.edu/academics/centers/center-immigration-law-and-policy); [David Hausman](/about.html#team)	|
| **Counsel** | [Michael Levin-Gesundheit](/about.html#team) |
| **Date**  	  |  May 2024	|
| **Agency response**  	|  None	|
| **Litigation** | &bull; Federal district court lawsuit (ongoing)<br/>&bull; Initial data provided March 2025<br/>&bull; Second data release in early June 2025<br/>&bull; Third release in late June 2025<br/>&bull; Fourth release in late July 2025 |
...
tibble::tribble(
  ...
  ~Filing,
  ~Date,
  "1 FOIA request.pdf", "ICE FOIA Office", "FOIA request", "Original request", as.Date("2024-05-01"),
  ...
  "ICE FOIA Office",
  "Letter",
  "Fourth interim data release confirmation letter",
  as.Date("2025-07-30"),

  "CILP v ICE Fourth Interim Release Envelope.pdf",
  "ICE FOIA Office",
  "Shipping Confirmation",
  "Fourth interim data release envelope",
  as.Date("2025-08-08")
) |>
  mutate(
    Filing = glue::glue(
...
|   	|   	|
|---	|---	|
| **Request** 	| Data on ICE initial apprehensions, risk classification assessments, detentions, and removals with anonymized identifiers for immigrants.  |
| **Agency**    | Immigration and Customs Enforcement |
| **Requestor** |  [ACLU Immigrants' Rights Project](https://www.aclu.org/issues/immigrants-rights); [David Hausman](/about.html#team) 	|
| **Date**  	  |  Oct. 2018 	|
| **Agency response**  	|  None	|
