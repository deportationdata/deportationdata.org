---
title: "All agency documentation"
---
...
This page includes government documents and information from all agencies relevant to immigration, including agencies within the Department of Homeland Security (DHS) and the Department of Justice (DOJ).
...
filtered_doc_data <- doc_data |>
  ...
  select(Type, Title = ShortTitle, Agency, Date, Link, Contributor) |>
...
Some documents were obtained via a [FOIA request](https://www.aclusocal.org/en/release-foia-documents-related-eoir-databases) by the [ACLU of Southern California](https://aclusocal.org), the [National Immigration Project](https://nipnlg.org), and [Mission Action](https://www.missionaction.org).
