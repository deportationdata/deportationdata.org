...
[Explore](/docs/ice/documents.html){.btn-action-primary .btn-action .btn .btn-outline-primary .btn-sm role="button"} 
...
The data comes from ICE itself in response to FOIA requests. In most cases, we provide the original data ICE provided without modification. We note any time we have modified the data, such as to make it possible to open.
