...
We posted a removals table for the late Jun. 2025 release, but not for the late Feb., early Jun., or late Jul. releases due to apparent errors. We discovered large between counts in the data and in ICE annual reporters. These concerns lead us to advise caution when performing any analysis of removals.

The most complete way to count deportations (removals) in the most recent release is to add up (1) people with departed dates in the relevant period from the arrests, detentions, detainers, and encounters tables; and (2) people with “removed” as their detention release reason in this period in the detentions table. To focus on removals after ICE arrest and detention, filter to the “Stay Release Reason” of “Removed” in the detentions table (while being careful not to count people more than once, since many people have information across more than one row in the detentions table–see our codebook for more details). 
