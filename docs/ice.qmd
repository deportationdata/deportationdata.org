...
### {{< bi arrow-repeat class="me-2" >}} Data processing

Steps and code used to create processed datasets for the most recent ICE release.

[Read](/docs/ice/processing.html){.btn-action-primary .btn-action .btn .btn-outline-primary .btn-sm role="button"} 
...
List of ICE field offices and maps of their areas of responsibility.
...
We previously did not post removals data in the late July ICE data release. Read [why we posted the dataset](/news/2025-09-29-update-ICE-removals.html) and now believe it is complete.
