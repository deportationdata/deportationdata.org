...
## Preguntas frecuentes sobre los datos {#faq}
...
Publicamos una tabla de deportaciones (remociones) para la publicación de finales de jun. de 2025, pero no para las publicaciones de finales de feb., principios de jun. o finales de jul. debido a aparentes errores. Detectamos grandes discrepancias entre los conteos de los datos y los informes anuales de ICE. Estas preocupaciones nos llevan a aconsejar precaución al realizar cualquier análisis de deportaciones.

La forma más completa de contar deportaciones (remociones) en la publicación más reciente es sumar (1) personas con fechas de salida en el período relevante de las tablas de arrestos, detenciones, órdenes de detención y encuentros; y (2) personas con “expulsado” como su razón de liberación de detención en este período en la tabla de detenciones. Para enfocarse en deportaciones (remociones) posteriores al arresto y detención de ICE, filtre por la “Razón de Liberación de Estadía” de “Expulsado” en la tabla de detenciones (teniendo cuidado de no contar a las personas más de una vez, ya que muchas personas tienen información en más de una fila en la tabla de detenciones; vea nuestro libro de códigos para más detalles).
