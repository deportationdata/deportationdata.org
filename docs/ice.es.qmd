...
* También proporcionamos un [libro de códigos (en inglés)](/docs/ice/codebook.html) que describe cada tabla de datos y los campos contenidos en ellas.
