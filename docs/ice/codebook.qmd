...
The Deportation Data Project provides a processed version of the [detentions data at the *stay* level](/data/processed/ice.html). The two citizens' stays in ICE detention would be represented in the stay level dataset like this, as two rows:
