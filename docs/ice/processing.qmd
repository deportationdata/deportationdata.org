...
col_def_code <- list(
  Dataset = colDef(html = TRUE, minWidth = 100),
  Code = colDef(
    html = TRUE,
    minWidth = 40,
    cell = function(value) {
...
tribble(
  ~Dataset                  , ~Code                                                                       ,
  "Arrests"                 , "https://github.com/deportationdata/ice/blob/main/code/arrests-latest.R"    ,
  "Detainer requests"       , "https://github.com/deportationdata/ice/blob/main/code/arrests-latest.R"    ,
  "Detention <b>stints</b>" , "https://github.com/deportationdata/ice/blob/main/code/detentions-latest.R" ,
  "Removals"                , "https://github.com/deportationdata/ice/blob/main/code/removals-latest.R"   ,
) |>
  reactable(
...
tribble(
  ~Dataset                 , ~Code                                                                             ,
  "Detention <b>stays</b>" , "https://github.com/deportationdata/ice/blob/main/code/detentions-stays-latest.R"
) |>
  reactable(
    theme = reactableTheme(
      tableStyle = list(backgroundColor = "transparent"),
...
tribble(
  ~Dataset                               , ~Code                                                                     ,
  "Field offices and sub-offices"        , "https://github.com/deportationdata/ice/blob/main/code/offices-scraper.R" ,
  "Field office areas of responsibility" , "https://github.com/deportationdata/ice/blob/main/code/offices-aors.R"
) |>
  reactable(
    theme = reactableTheme(
      tableStyle = list(backgroundColor = "transparent"),
