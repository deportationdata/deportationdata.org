...
field_offices_sf <-
  {
    ...
    field_offices_sf |>
      ...
      tidyr::nest(
        sub_offices = c(sub_office_name, sub_office_area, sub_office_address)
      ) |>
      ungroup()
  }
