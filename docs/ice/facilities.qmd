...
leaflet() |>
  ...
  addLayersControl(
    overlayGroups = c("ICE areas of responsibility", "ICE ERO field offices"),
    options = layersControlOptions(collapsed = FALSE)
  ) |>
  setView(lng = -98.5795, lat = 39.8283, zoom = 4)
```

## List of ICE ERO field offices and sub-offices
...
field_office_downloads <- tribble(
  ~name, ~url,
  "ICE ERO Field Offices (shapefile)", "
  )
```
...
detention_facility_df |>
  ...
  reactable(
    ...
    columnGroups = list(
      ...
      colGroup(name = "Individuals", columns = c("N Individuals", "N Individuals 2025"))
    )
  ) 
```
