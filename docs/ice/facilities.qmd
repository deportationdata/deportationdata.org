...
aor_sf <-
  sfarrow::st_read_feather(
    "https://github.com/deportationdata/ice/raw/refs/heads/ice-offices/data/ice-aor-shp.feather"
  ) |>
...
- **ICE areas of responsibility (AORs)**: Geographic region managed by each ICE field office. The AOR geography was created by the [Center for Human Rights at the University of Washington](https://jsis.washington.edu/humanrights).
