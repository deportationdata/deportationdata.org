...
```{r}
tibble::tribble(
  ~Agency, ~`FOIA request ID`, ~Date, ~Types, ~source_label, ~source_URL,
  "ICE", "2023_ICFO_42034", "Nov. 2023", "Arrests, Detentions, Removals, Risk classification assessments", "ICE", "https://www.ice.gov/doclib/foia/thirdPartyRequests/2023-ICFO-42034.zip",
  "ICE", "2022-ICFO-09023", "2024", "Arrests, Encounters, Removals", "UWCHR", "https://github.com/UWCHR/ice-enforce",
  "ICE", "2022-ICFO-09022", "2024", "Detentions", "UWCHR", "https://github.com/UWCHR/ice-detain",
  "ICE", "2019-ICFO-32423; 2021-ICAP-00188", "2019; 2022", "Flights", "UWCHR", "https://github.com/UWCHR/ice-air",
  "ICE", "Unknown", "2016", "Detainers", "NPR", "https://github.com/nprapps/sanctuary-cities",
  "ICE", "2024-ICFO-39357", "Mar. 2025", "Arrests, Detainers, Detentions, Encounters", "ICE", "https://www.ice.gov"
) |>
  mutate(Source = glue::glue("<a href='{source_URL}'>{source_label}</a>"), .keep = "unused") |>
  reactable::reactable(pagination = FALSE, sortable = FALSE, resizable = FALSE)
```
